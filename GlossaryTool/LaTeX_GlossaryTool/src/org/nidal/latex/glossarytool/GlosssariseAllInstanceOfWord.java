...
public class GlosssariseAllInstanceOfWord {
...
class WordSearcher5 {
 ...
 //   Intelligence intelligence = new Intelligence();
  public WordSearcher5(JTextComponent comp) {
    this.comp = comp;
...
class UnderlineHighlighter5 extends DefaultHighlighter {
  public UnderlineHighlighter5(Color c) {
