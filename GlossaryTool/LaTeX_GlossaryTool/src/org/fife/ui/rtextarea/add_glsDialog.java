...
// * 11/14/2003
// *
// * add_glsDialog.java - Dialog for replacing text in a GUI.
...
// * <p>An application can use a <code>add_glsDialog</code> as follows.  It is suggested
...
// * @version 1.0
// */
public class add_glsDialog extends ReplaceDialog {
//
...
//	 * @param listener The component that listens for {@link SearchEvent}s.
//	 */
//	public add_glsDialog(Frame owner, SearchListener listener) {
//		super(owner);
//		init(listener);
//	}
//
...
//		setTitle(getString("add_glsDialogTitle"));
//		setResizable(true);
//		pack();
